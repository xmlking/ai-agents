"""
1. Run: `uv sync --all-packages` to install dependencies (openai agno cohere lancedb tantivy sqlalchemy pylance)
2. Export your OPENAI_API_KEY and CO_API_KEY
3. Run: `uv run --package agno-adventures apps/agno-adventures/agentic_rag_with_reranking.py` to run the agent
"""
